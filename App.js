...
const ADHAN_RECITERS = [
  { id:"mishary",    name:"Mishary Al-Afasy",   flag:"🇰🇼", url:"https://www.islamcan.com/audio/adhan/azan1.mp3" },
  { id:"abdulbasit", name:"Abdul Basit",         flag:"🇪🇬", url:"https://www.islamcan.com/audio/adhan/azan2.mp3" },
  { id:"nasser",     name:"Nasser Al-Qatami",    flag:"🇸🇦", url:"https://www.islamcan.com/audio/adhan/azan3.mp3" },
  { id:"makkah",     name:"Adhan Makkah",        flag:"🕋", url:"https://www.islamcan.com/audio/adhan/azan4.mp3" },
  { id:"madinah",    name:"Adhan Madinah",       flag:"🕌", url:"https://www.islamcan.com/audio/adhan/azan5.mp3" },
]
...
function ArticlesIslamiques({ lang="fr" }) {
  ...
  const ARTICLES = [
    { title:{fr:"La Kaaba: voyage a travers l'histoire sacree",en:"The Kaaba: A Journey Through Sacred History",ar:"الكعبة: رحلة عبر التاريخ المقدس",tr:"Kabe: Kutsal Tarih Yolculuğu",de:"Die Kaaba: Eine Reise durch heilige Geschichte",nl:"De Kaaba: Een reis door heilige geschiedenis",es:"La Kaaba: Un viaje a través de la historia sagrada",id:"Ka'bah: Perjalanan Melalui Sejarah Suci",ur:"کعبہ: مقدس تاریخ کا سفر",ms:"Kaabah: Perjalanan Melalui Sejarah Suci",it:"La Kaaba: Un viaggio nella storia sacra",pt:"A Caaba: Uma viagem pela história sagrada"}, cat:"DEEN", emoji:"🕋", content:{fr:"La Kaaba, situee au coeur de la Mosquee Al-Haram a La Mecque, est le lieu le plus sacre de l'Islam. Construite par le prophete Ibrahim (Abraham) et son fils Ismail, elle est le point vers lequel tous les musulmans se tournent pour prier (Qibla). Chaque annee, des millions de pelerins accomplissent le Tawaf — sept tours autour de la Kaaba — lors du Hajj et de la Omra. La Pierre Noire (Al-Hajar Al-Aswad), encastree dans son angle est, est embrassee ou saluee par les pelerins. Le Prophete Muhammad ﷺ a restaure la Kaaba au monotheisme pur en detruisant les 360 idoles qui s'y trouvaient lors de la conquete de La Mecque en 630.",en:"The Kaaba, located at the heart of Al-Haram Mosque in Mecca, is the most sacred site in Islam. Built by Prophet Ibrahim (Abraham) and his son Ismail, it is the point toward which all Muslims turn to pray (Qibla). Every year, millions of pilgrims perform Tawaf — seven circuits around the Kaaba — during Hajj and Umrah. The Black Stone (Al-Hajar Al-Aswad), set into its eastern corner, is kissed or saluted by pilgrims. Prophet Muhammad ﷺ restored the Kaaba to pure monotheism by destroying the 360 idols within it during the conquest of Mecca in 630.",ar:"الكعبة المشرفة في قلب المسجد الحرام بمكة المكرمة هي أقدس مكان في الإسلام. بناها النبي إبراهيم وابنه إسماعيل عليهما السلام. كل عام يطوف الملايين حولها سبعة أشواط.",tr:"Kabe, Mekke'deki Mescid-i Haram'ın kalbinde yer alan İslam'ın en kutsal mekanıdır."}},
    { title:{fr:"Le repentir (Tawbah) en Islam",en:"Repentance (Tawbah) in Islam",ar:"التوبة في الإسلام",tr:"İslam'da Tövbe",de:"Reue (Tawbah) im Islam",nl:"Berouw (Tawbah) in de Islam",es:"El arrepentimiento (Tawbah) en el Islam",id:"Taubat dalam Islam",ur:"اسلام میں توبہ",ms:"Taubat dalam Islam",it:"Il pentimento (Tawbah) nell'Islam",pt:"O arrependimento (Tawbah) no Islã"}, cat:"DEEN", emoji:"🤲", content:{fr:"Le repentir (Tawbah) est un concept central en Islam. Allah dit dans le Coran : 'Dis : O Mes serviteurs qui avez commis des exces a votre propre detriment, ne desesperez pas de la misericorde d'Allah. Car Allah pardonne tous les peches.' (39:53). Les conditions de la Tawbah sont : regretter sincerement le peche, cesser immediatement, avoir la ferme intention de ne pas y revenir, et si le peche implique les droits d'autrui, restituer ces droits. La porte du repentir reste ouverte tant que le soleil ne se leve pas de l'ouest. Le Prophete ﷺ demandait pardon a Allah plus de 70 fois par jour.",en:"Repentance (Tawbah) is a central concept in Islam. Allah says: 'Say: O My servants who have transgressed against themselves, do not despair of the mercy of Allah. Indeed, Allah forgives all sins.' (39:53). Conditions: sincerely regretting the sin, ceasing immediately, firm intention not to return, and restoring others' rights if applicable. The door of repentance remains open until the sun rises from the west. The Prophet ﷺ sought forgiveness more than 70 times daily.",ar:"التوبة مفهوم أساسي في الإسلام. قال تعالى: قل يا عبادي الذين أسرفوا على أنفسهم لا تقنطوا من رحمة الله.",tr:"Tövbe İslam'da merkezi bir kavramdır. Allah buyuruyor: 'De ki: Ey kendilerine kötülük etmiş kullarım! Allah'ın rahmetinden ümidinizi kesmeyin.'"}},
    { title:{fr:"L'importance du Dhikr quotidien",en:"The Importance of Daily Dhikr",ar:"أهمية الذكر اليومي",tr:"Günlük Zikirin Önemi",de:"Die Bedeutung des täglichen Dhikr",nl:"Het belang van dagelijkse Dhikr",es:"La importancia del Dhikr diario",id:"Pentingnya Dzikir Harian",ur:"روزانہ ذکر کی اہمیت",ms:"Kepentingan Zikir Harian",it:"L'importanza del Dhikr quotidiano",pt:"A importância do Dhikr diário"}, cat:"DEEN", emoji:"📿", content:{fr:"Le Dhikr (rappel d'Allah) est l'une des pratiques les plus meritoires en Islam. Allah dit : 'Souvenez-vous de Moi, Je Me souviendrai de vous' (2:152). Le Prophete ﷺ a dit : 'La difference entre celui qui invoque Allah et celui qui ne L'invoque pas est comme la difference entre le vivant et le mort.' Quelques formules essentielles : SubhanAllah (Gloire a Allah), Alhamdulillah (Louange a Allah), Allahu Akbar (Allah est le plus Grand), La ilaha illallah (Il n'y a de dieu qu'Allah). Les adhkar du matin et du soir protegent le croyant tout au long de la journee.",en:"Dhikr (remembrance of Allah) is one of the most meritorious practices in Islam. Allah says: 'Remember Me, I will remember you' (2:152). The Prophet ﷺ said: 'The difference between one who remembers Allah and one who doesn't is like the difference between the living and the dead.' Essential formulas: SubhanAllah, Alhamdulillah, Allahu Akbar, La ilaha illallah. Morning and evening adhkar protect the believer throughout the day.",ar:"الذكر من أفضل الأعمال في الإسلام. قال تعالى: فاذكروني أذكركم.",tr:"Zikir İslam'daki en faziletli amellerden biridir."}},
    { title:{fr:"Le coeur de Tawhid: Sourate Al-Ikhlas",en:"The Heart of Tawhid: Surah Al-Ikhlas",ar:"قلب التوحيد: سورة الإخلاص",tr:"Tevhidin Kalbi: İhlas Suresi",de:"Das Herz des Tawhid: Surah Al-Ikhlas",nl:"Het hart van Tawhid: Surah Al-Ikhlas",es:"El corazón del Tawhid: Sura Al-Ikhlas",id:"Inti Tauhid: Surah Al-Ikhlas",ur:"توحید کا دل: سورۃ الاخلاص",ms:"Inti Tauhid: Surah Al-Ikhlas",it:"Il cuore del Tawhid: Surah Al-Ikhlas",pt:"O coração do Tawhid: Surata Al-Ikhlas"}, cat:"QURAN", emoji:"📖", content:{fr:"Sourate Al-Ikhlas (Le Monotheisme Pur), bien que composee de seulement 4 versets, equivaut a un tiers du Coran en merite. Elle resume toute la croyance islamique : 'Dis : Il est Allah, Unique. Allah, Le Seul a etre implore. Il n'a pas engendre et n'a pas ete engendre. Et nul n'est egal a Lui.' Le Prophete ﷺ a demande : 'L'un de vous est-il incapable de lire un tiers du Coran en une nuit ?' Les compagnons trouverent cela difficile. Il dit : 'Qul Huwa Allahu Ahad equivaut a un tiers du Coran.' La reciter 3 fois equivaut a avoir recite le Coran en entier.",en:"Surah Al-Ikhlas (Pure Monotheism), though only 4 verses, equals one-third of the Quran in merit. It summarizes the entire Islamic belief: 'Say: He is Allah, the One. Allah, the Eternal Refuge. He neither begets nor is born. Nor is there any equivalent to Him.' The Prophet ﷺ said: 'Qul Huwa Allahu Ahad equals one-third of the Quran.' Reciting it 3 times equals reciting the entire Quran.",ar:"سورة الإخلاص على الرغم من أنها 4 آيات فقط تعادل ثلث القرآن.",tr:"İhlas Suresi sadece 4 ayet olmasına rağmen Kur'an'ın üçte birine denktir."}},
    { title:{fr:"5 facons d'enseigner le Coran aux enfants",en:"5 Ways to Teach Kids About the Quran",ar:"5 طرق لتعليم الأطفال القرآن",tr:"Çocuklara Kur'an Öğretmenin 5 Yolu",de:"5 Wege, Kindern den Koran beizubringen",nl:"5 manieren om kinderen de Koran te leren",es:"5 formas de enseñar el Corán a los niños",id:"5 Cara Mengajarkan Al-Quran kepada Anak",ur:"بچوں کو قرآن سکھانے کے 5 طریقے",ms:"5 Cara Mengajar Anak-anak Al-Quran",it:"5 modi per insegnare il Corano ai bambini",pt:"5 maneiras de ensinar o Alcorão às crianças"}, cat:"QURAN", emoji:"👶", content:{fr:"1. Commencez tot — des l'age de 3-4 ans, faites-leur ecouter des recitations douces. 2. Rendez-le amusant — utilisez des jeux, des couleurs, des recompenses. Les applis comme FADJR aident enormement. 3. Soyez l'exemple — recitez devant eux, ils imitent naturellement. 4. Commencez par les sourates courtes — Al-Fatiha, Al-Ikhlas, Al-Falaq, An-Nas. 5. Encouragez, ne forcez pas — le Coran doit etre associe a la joie, pas a la punition. Le Prophete ﷺ a dit : 'Le meilleur d'entre vous est celui qui apprend le Coran et l'enseigne.'",en:"1. Start early — from age 3-4, play gentle recitations. 2. Make it fun — use games, colors, rewards. Apps like FADJR help enormously. 3. Be the example — recite in front of them. 4. Start with short surahs — Al-Fatiha, Al-Ikhlas, Al-Falaq, An-Nas. 5. Encourage, don't force — Quran should be associated with joy. The Prophet ﷺ said: 'The best among you is the one who learns the Quran and teaches it.'",ar:"1. ابدأ مبكراً من سن 3-4 سنوات. 2. اجعله ممتعاً. 3. كن القدوة. 4. ابدأ بالسور القصيرة. 5. شجع ولا تجبر.",tr:"1. Erken başlayın. 2. Eğlenceli hale getirin. 3. Örnek olun. 4. Kısa surelerle başlayın. 5. Teşvik edin, zorlamayın."}},
    { title:{fr:"Comment l'Islam encourage la croissance",en:"How Islam Encourages Growth",ar:"كيف يشجع الإسلام النمو",tr:"İslam Nasıl Gelişimi Teşvik Eder",de:"Wie der Islam Wachstum fördert",nl:"Hoe de Islam groei aanmoedigt",es:"Cómo el Islam fomenta el crecimiento",id:"Bagaimana Islam Mendorong Pertumbuhan",ur:"اسلام کس طرح ترقی کی حوصلہ افزائی کرتا ہے",ms:"Bagaimana Islam Menggalakkan Pertumbuhan",it:"Come l'Islam incoraggia la crescita",pt:"Como o Islã encoraja o crescimento"}, cat:"LIFESTYLE", emoji:"🌱", content:{fr:"L'Islam encourage la croissance personnelle a travers plusieurs piliers : 1. La science — 'Cherchez le savoir du berceau au tombeau'. Le premier mot revele fut 'Iqra' (Lis). 2. L'introspection — la priere 5 fois par jour est un moment de reflexion et de recentrage. 3. La discipline — le jeune enseigne la maitrise de soi. 4. La generosite — la zakat et la sadaqa developpent l'empathie. 5. La communaute — la priere en congregation, le Hajj, renforcent les liens sociaux. Le Prophete ﷺ a dit : 'Le croyant fort est meilleur et plus aime d'Allah que le croyant faible, et dans chacun il y a du bien.'",en:"Islam encourages personal growth through: 1. Knowledge — 'Seek knowledge from the cradle to the grave.' The first word revealed was 'Iqra' (Read). 2. Self-reflection — 5 daily prayers for reflection. 3. Discipline — fasting teaches self-control. 4. Generosity — zakat and sadaqah develop empathy. 5. Community — congregational prayer and Hajj strengthen bonds.",ar:"يشجع الإسلام النمو الشخصي من خلال: العلم، التأمل، الانضباط، السخاء، والمجتمع.",tr:"İslam kişisel gelişimi teşvik eder: İlim, tefekkür, disiplin, cömertlik ve topluluk."}},
  ]
